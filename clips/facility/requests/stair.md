...
The gallery is `x 11.62 .. 15.25` by `z 4.50 .. 6.75`, top **6.30**, bedded 0.15 into the east wall
at 15.10 and the north wall at 6.60. Its open edges — the ones carrying a balustrade now, because a
landing over a 4.5 m drop has to — are:

- `z = 4.50`, from `x 11.62` to `15.10`
- `x = 11.62`, from `z 4.50` to `5.40` (the head of the well)
