...
**Still open in R10.** The quadratic terms — `uw`, `u²`, `w²`, the saddle and the curvature — are
not built. They are what make a voxel cylinder read as a cylinder rather than as a faceted prism,
and they accumulate exactly as the linear ones do, at two more words a slot.
